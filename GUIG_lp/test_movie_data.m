...
opts.eta = 0.25;               %  rate = 0.7 eta = 0.06; rate = 0.5, eta = 0.08; rate = 0.8, eta = 0.06; For dataset = 2;
...
para_name = [Para_fold,'_','GUIG_lp_',rate,'_',fname,'.mat'];
save(['D:\贾西西\2017工作\非凸低秩矩阵分解方法\低秩矩阵分解代码\GUIG_real_MC\Para_setting\',para_name],'opts');
record_name = ['Time_RMSE_GUIG_lp_',rate,'_',fname,'.mat'];
